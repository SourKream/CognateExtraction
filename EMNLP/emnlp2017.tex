...
\texttt{TODO: Describe Character embeddings}

%%%%%%%%%%%%%%%%%%%%%%
\subsection{LSTM network}

\texttt{TODO: Describe LSTM and add equations}

%%%%%%%%%%%%%%%%%%%%%%
\subsection{Attention}

\texttt{TODO: Add attention equations}
...
\texttt{TODO: Describe Pretraining inspiration}
...
CharCNN + Lang                     & 62.8                   & \textbf{60.8}                  & \textbf{84.2}           \\ \hline
